...
@export var action_left := "action_left"
@export var action_right := "action_right"
@export var action_up := "action_up"
@export var action_down := "action_down"
...
func _ready() -> void:
	...
	if !(OS.has_feature("web_android") or OS.has_feature("web_ios")) and visibility_mode == Visibility_mode.TOUCHSCREEN_ONLY :
		hide()
		pass
